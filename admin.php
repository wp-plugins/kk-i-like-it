...
function kklike_admin_enqueue_scripts(){
	...
	wp_enqueue_script('jquery-ui-core');
  	...
  	wp_register_script('kklike-ui-widget-js', WP_PLUGIN_URL .'/kkilikeit/js/jquery-ui.custom.js', array('jquery-ui-core'), '1.0');
	wp_enqueue_script('kklike-ui-widget-js');
	
	wp_enqueue_style('kklike-css', WP_PLUGIN_URL .'/kkilikeit/css/kklike.css?v=1.0');
	wp_enqueue_style('kklike-afront-css', WP_PLUGIN_URL .'/kkilikeit/css/kklike-front.css?v=1.0');
	
	wp_register_script('kklike-js', WP_PLUGIN_URL .'/kkilikeit/js/admin.js', array('jquery'), '1.0');
	wp_enqueue_script('kklike-js');
    
    /* ============= CHECKBOX PLUGIN ============= */
    wp_register_script('kklike-checkbox', WP_PLUGIN_URL .'/kkilikeit/js/iphone-style-checkboxes.js', array('jquery'), '1.0');
    ...
    wp_register_script('kklike-admin-color', WP_PLUGIN_URL .'/kkilikeit/js/colorpicker.js', array('jquery'), '1.0');
    wp_enqueue_script('kklike-admin-color');
    
	/* ============= JS COOKIE PLUGIN ============= */
	wp_register_script('kklike-admin-cookie', WP_PLUGIN_URL .'/kkilikeit/js/jquery.cookie.js', array('jquery'), '1.0');
    wp_enqueue_script('kklike-admin-cookie');
    
    wp_enqueue_style('kklike-jquery-ui-css', WP_PLUGIN_URL .'/kkilikeit/css/black-tie/jquery-ui.custom.css?v=1.0');
	
	/* ============= Tooltip PLUGIN ============= */
	wp_enqueue_style('kklike-css-tip', WP_PLUGIN_URL .'/kkilikeit/css/jquery.qtip.css');
	wp_register_script('kklike-tip', WP_PLUGIN_URL .'/kkilikeit/js/jquery.qtip.min.js', array('jquery'), '1.0.0');
...
function kklike_enqueue_scripts(){
	...
	wp_enqueue_style('kklike-front-css', WP_PLUGIN_URL .'/kkilikeit/css/kklike-front.css?v=1.0');
	
	wp_register_script('kklike-front-js', WP_PLUGIN_URL .'/kkilikeit/js/kklike-front.js', array('jquery'), '1.0');
